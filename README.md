...
Реализован веб-интерфейс с функциями создания и удаления комнат, бронирований и оборудования, также просмотр всех комнат и оборудования. 

В дальнейшем будут добавлены в интерфейс реализованные функции просмотра всех бронирований, а также поика свободных комнат.
